      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: 28, width: 340, boxShadow: '0 20px 60px rgba(0,0,0,0.2)' }}>
        ...
        <div ref={ref} style={{ fontFamily: "'Courier New', monospace", fontSize: 13, background: '#fffdf7', border: '1px dashed #d1c89a', borderRadius: 8, padding: '16px 18px', marginBottom: 16 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 8 }}>
            <div style={{ fontWeight: 700, fontSize: 16 }}>TB. PELITA JAYA</div>
          ...
          <div style={{ borderTop: '1px dashed #ccc', margin: '8px 0' }} />
          <div style={{ textAlign: 'center', fontSize: 11, color: '#888' }}>Terima kasih atas kunjungan Anda</div>
          <div style={{ textAlign: 'center', fontSize: 11, color: '#888' }}>CP: 085768520718</div>
          <div style={{ textAlign: 'center', fontSize: 10.5, fontWeight: 900, marginTop: 6, color: '#000' }}>Barang yang sudah dibeli tidak dapat ditukar/dikembalikan</div>
        </div>
