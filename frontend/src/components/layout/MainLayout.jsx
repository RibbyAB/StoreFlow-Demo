...
const menu = [
  ...
  { to: '/pengaturan', icon: '⚙️', label: 'Pengaturan', ownerOnly: true },
];
    ...
    <div style={{ display: 'flex', height: '100dvh', fontFamily: 'sans-serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <aside style={{
        ...
        <div style={{
          ...
          {(sidebarOpen || isMobile) && <span style={{ fontWeight: 700, fontSize: 15 }}>{pengaturan?.nama_toko || 'Toko'}</span>}
        </div>
        ...
        <div style={{ padding: '12px 16px', paddingBottom: 'max(12px, env(safe-area-inset-bottom))', borderTop: '1px solid #334155' }}>
